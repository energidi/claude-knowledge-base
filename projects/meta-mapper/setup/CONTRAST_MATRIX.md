...
- L = 0.2126 _ R_lin + 0.7152 _ G_lin + 0.0722 \* B_lin
...
_All ratios computed using WCAG 2.1 formula. Verify against actual rendered output with Lighthouse, axe, or the Salesforce Accessibility Checker before shipping._
