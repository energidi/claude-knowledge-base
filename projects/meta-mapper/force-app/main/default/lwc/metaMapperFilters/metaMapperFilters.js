...
function sanitizeSchema(obj) {
    ...
    return {
        ...
        confidenceThreshold: typeof obj.confidenceThreshold === 'number' ? obj.confidenceThreshold : 0,
        showCircular: typeof obj.showCircular === 'boolean' ? obj.showCircular : true,
        showDynamic: typeof obj.showDynamic === 'boolean' ? obj.showDynamic : true,
        showSupplemental: typeof obj.showSupplemental === 'boolean' ? obj.showSupplemental : true
    };
}
