...
export default class MetaMapperFilterPanel extends LightningElement {
  ...
  get maxLevel() {
    ...
    return this._filters.maxLevel >= 9999
      ? this.maxDepthValue
      : this._filters.maxLevel;
  }
  get confidenceThreshold() {
    return this._filters.confidenceThreshold;
  }
  get showCircular() {
    return this._filters.showCircular;
  }
  get showDynamic() {
    return this._filters.showDynamic;
  }
  get showSupplemental() {
    return this._filters.showSupplemental;
  }
  ...
  handleConfidenceChange(event) {
    ...
    this._emitChange({ confidenceThreshold: clamped });
  }
